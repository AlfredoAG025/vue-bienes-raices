...
<template>
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            <div class="my-5">
                <p v-if="image" class="font-weight-bold">Imagen Nueva:</p>
                <p v-else class="font-weight-bold">Imagen Actual:</p>
                
                
                <img v-if="image" class="w-50" :src="image" :alt="'Imagen Nueva de ' + propiedad?.titulo"> 

                <img v-else class="w-50" :src="propiedad?.imagen" :alt="'Imagen Actual de ' + propiedad?.titulo"> 
            </div>
